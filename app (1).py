...
# Rule-based overrides (always salty)
...
with gr.Blocks() as demo:
    ...
    with gr.Tab("Download PDB"):
        seq_in_pdb = gr.Textbox(label="Peptide sequence", placeholder="e.g., EDEGEQPDFP")
        pdb_file = gr.File(label="Download PDB", type="binary")
        seq_in_pdb.change(fn=save_pdb, inputs=seq_in_pdb, outputs=pdb_file)
